...
import static com.antest1.kcanotify.h5.KcaConstants.DB_KEY_LATESTDEV;
...
>>>>>>> 3e3ce46c3f6db9edef1979373cfd53b68d496b9e
    ...
    private void setItemLayout(int index, JsonObject data) {
        int typeres = 0;
        ImageView ed_icon = mView.findViewById(getId("ed_icon" + index, R.id.class));
        TextView ed_name = mView.findViewById(getId("ed_name" + index, R.id.class));
        TextView ed_count = mView.findViewById(getId("ed_count" + index, R.id.class));
        ...
        mView.findViewById(getId("ed_item" + index, R.id.class)).setVisibility(View.VISIBLE);
    }
