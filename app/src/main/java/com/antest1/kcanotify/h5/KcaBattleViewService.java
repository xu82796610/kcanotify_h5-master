...
import static com.antest1.kcanotify.h5.KcaApiData.getNodeFullInfo;
import static com.antest1.kcanotify.h5.KcaApiData.getShipTranslation;
import static com.antest1.kcanotify.h5.KcaApiData.getUseitemCount;
import static com.antest1.kcanotify.h5.KcaApiData.getUseitemTranslation;
...
public class KcaBattleViewService extends Service {
    ...
    public void setBattleview() {
        ...
        if (api_data != null) {
            ...
            if (api_data.has("api_ship_ke")) { // Battle (Common)
                ...
                Log.e("KCA", "ESD: " + enemyShipData.size());
                ...
                if (api_data.has("api_ship_ke_combined")) {
                    ...
                    Log.e("KCA", "ECSD: " + enemyCombinedShipData.size());
    ...
    private boolean checkStart(String url) {
        ...
        return !url.equals(API_REQ_COMBINED_BATTLE_MIDNIGHT_EC);
    }
}