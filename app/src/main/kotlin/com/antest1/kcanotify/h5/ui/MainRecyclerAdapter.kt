...
import com.antest1.kcanotify.h5.helper.ItemTouchHelperAdapter
import com.antest1.kcanotify.h5.helper.ItemTouchHelperViewHolder
...
class MainRecyclerAdapter(val activity: V2rayNGActivity) : RecyclerView.Adapter<MainRecyclerAdapter.BaseViewHolder>()
    ...
    private var mActivity: V2rayNGActivity = activity
