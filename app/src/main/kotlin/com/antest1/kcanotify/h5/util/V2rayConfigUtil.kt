...
import com.antest1.kcanotify.h5.KcaApplication
import com.antest1.kcanotify.h5.AppConfig
import com.antest1.kcanotify.h5.dto.AngConfig.VmessBean
import com.antest1.kcanotify.h5.dto.V2rayConfig
import com.antest1.kcanotify.h5.ui.SettingsActivity
import org.json.JSONException
import org.json.JSONObject
import org.json.JSONArray
import com.antest1.kcanotify.h5.dto.EConfigType
...
//    }
     ...
     * 生成v2ray的客户端配置文件
     */
    fun getV2rayConfig(app: KcaApplication, vmess: VmessBean): Result {
...
//            }
     ...
     * 生成v2ray的客户端配置文件
     */
    private fun getV2rayConfigType1(app: KcaApplication, vmess: VmessBean): Result {
...
//            }
     ...
     * 生成v2ray的客户端配置文件
     */
    private fun getV2rayConfigType2(app: KcaApplication, vmess: VmessBean): Result {
        val result = Result(false, "")
        try {
            val guid = vmess.guid
     ...
     *
     */
    private fun inbounds(vmess: VmessBean, v2rayConfig: V2rayConfig, app: KcaApplication): Boolean {
        try {
...
//            }
     ...
     * vmess协议服务器配置
     */
    private fun outbounds(vmess: VmessBean, v2rayConfig: V2rayConfig, app: KcaApplication): Boolean {
        try {
...
//                        }
     ...
     * routing
     */
    private fun routing(vmess: VmessBean, v2rayConfig: V2rayConfig, app: KcaApplication): Boolean {
        try {
...
//                                    || it.startsWith("full:"))
     ...
     * Custom Dns
     */
    private fun customLocalDns(vmess: VmessBean, v2rayConfig: V2rayConfig, app: KcaApplication): Boolean {
        try {
     ...
     * Custom Remote Dns
     */
    private fun customRemoteDns(vmess: VmessBean, v2rayConfig: V2rayConfig, app: KcaApplication): Boolean {
        try {
            val servers = ArrayList<Any>()
    ...
    private fun parseDomainNameAndTag(app: KcaApplication, jsonConfig: String) {
        try {
