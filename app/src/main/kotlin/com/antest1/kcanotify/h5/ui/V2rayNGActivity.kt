...
import com.antest1.kcanotify.h5.helper.SimpleItemTouchHelperCallback
import com.antest1.kcanotify.h5.util.AngConfigManager.configs
import kotlinx.coroutines.*
import libv2ray.Libv2ray

class V2rayNGActivity : BaseActivity(), NavigationView.OnNavigationItemSelectedListener {
    companion object {
        ...
        layout_test.setOnClickListener {
            if (isRunning) {
                ...
                GlobalScope.launch(Dispatchers.IO) {
                    val result = Utils.testConnection(this@V2rayNGActivity, socksPort)
...
//        bindService(intent, mConnection, BIND_AUTO_CREATE)
        ...
        mMsgReceive = ReceiveMessageHandler(this@V2rayNGActivity)
...
//    }
    ...
    private class ReceiveMessageHandler(activity: V2rayNGActivity) : BroadcastReceiver() {
        internal var mReference: SoftReference<V2rayNGActivity> = SoftReference(activity)
