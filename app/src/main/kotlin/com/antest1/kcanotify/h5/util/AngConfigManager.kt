...
import com.antest1.kcanotify.h5.AppConfig.ANG_CONFIG
import com.antest1.kcanotify.h5.AppConfig.PREF_CURR_CONFIG
import com.antest1.kcanotify.h5.AppConfig.PREF_CURR_CONFIG_GUID
import com.antest1.kcanotify.h5.AppConfig.PREF_CURR_CONFIG_NAME
import com.antest1.kcanotify.h5.AppConfig.SOCKS_PROTOCOL
import com.antest1.kcanotify.h5.AppConfig.SS_PROTOCOL
import com.antest1.kcanotify.h5.AppConfig.VMESS_PROTOCOL
...
import com.antest1.kcanotify.h5.dto.VmessQRCode
import java.net.URI
import java.net.URLDecoder
import java.util.*

object AngConfigManager {
    private lateinit var app: KcaApplication
    private lateinit var angConfig: AngConfig
    val configs: AngConfig get() = angConfig

    @JvmStatic
    fun inject(app: KcaApplication) {
        this.app = app
        if (app.firstRun) {
        }
        loadConfig()
